...
const WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbxgelbJ-5KGmfqXnP8qS6SFgAPZxogOESpkt9BL2bdT3NjpHdoYVTJIrzs0pKzYrSxgyA/exec';
...
async function sendToSheets(payload){
  ...
  try {
    ...
    // Sesetengah telefon/browser block response Google Apps Script sebagai CORS.
    // Fallback no-cors masih menghantar data ke Apps Script, tetapi browser tidak boleh baca jawapan server.
    ...
    return { ok:true, success:true, message:'Booking dihantar. Sila semak Google Sheets untuk pengesahan.' };
  }
}
